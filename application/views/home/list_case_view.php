            ...
            <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #d6d4d0;">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link text-success" href="<?= site_url('form/allcase'); ?>">ติดตามงาน</a>
                        </li>
    ...
    <div class="row">
        <div class="col col-sm-12 col-md-12">
			<div class="row text-right justify-content-end">
				<label class="col-md-2 h3">สถานะ:</label>
				<select id="case_status" name="case_status" class="form-control col-md-3 mr-3">		
					<option value="0" <?= ($case_status == 0 || $case_status == "") ? "selected" : "" ?> >-ทั้งหมด-</option>
					<option value="1" <?= ($case_status == 1 ) ? "selected" : "" ?> >-รอดำเนินการ-</option>
					<option value="2" <?= ($case_status == 2 ) ? "selected" : "" ?> >-กำลังดำเนินการ-</option>
					<option value="3" <?= ($case_status == 3 ) ? "selected" : "" ?> >-เสร็จสิ้น-</option>
					<option value="4" <?= ($case_status == 4 ) ? "selected" : "" ?> >-ยกเลิก-</option>
				</select>
			</div>
