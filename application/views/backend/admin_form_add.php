            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form role="form" action="<?= site_url('admin/adding'); ?>" method="post"
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="email" name="admin_email" class="form-control" required
                                            placeholder="email" value="<?= set_value('admin_email'); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="password" name="admin_pwd" class="form-control" required
                                            placeholder="ภาษาอังกฤษ/ตัวเลข/ขั้นต่ำ 4 ตัว" minlength="4"
                                            value="<?= set_value('admin_pwd'); ?>" pattern="^[a-zA-Z0-9]+$"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="admin_name" class="form-control" required
                                            placeholder="ชื่อ ขั้นต่ำ 4 ตัว" value="<?= set_value('admin_name'); ?>"
                                            minlength="4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="tel" name="admin_phone" class="form-control" placeholder="012-345-6789"
                                            pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" value="<?= set_value('admin_phone'); ?>"
                                            required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <a class="btn btn-danger" href="<?php echo  site_url('admin'); ?>"
