    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                ...
                <a href="<?= site_url('jobs/bystatus/3');?>?status=เสร็จสิ้น" class="btn btn-success"> ปิดงาน <span class="badge"><?= $qstatus3->totalstatus3;?></span></a>
                <a href="<?= site_url('jobs/bystatus/4');?>?status=ยกเลิก" class="btn btn-danger"> ยกเลิก <span class="badge"><?= $qstatus4->totalstatus4;?></span></a>
                <br><br>
